<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddForm.aspx.cs" Inherits="WelfareSurvey.AddForm" %>
        ...
        <div id="wrapper">
            ...
            <fieldset>
                ...
                <div style="font-size: large; color: red;">
                    Please fill family details only if they are participating to the event
                </div>
