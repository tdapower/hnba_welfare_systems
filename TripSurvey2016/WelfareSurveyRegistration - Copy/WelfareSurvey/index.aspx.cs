...
namespace WelfareSurvey
{
    public partial class index : System.Web.UI.Page
    {
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            if (validateEPF(ddlCompany.SelectedValue,txtEPF.Text.Trim()))
            {
            ...
            {
                //ScriptManager.RegisterStartupScript(this, GetType(), "Message", "alert('Invalid EPF Number');", true);
        ...
        private bool validateEPF(string company,string epf)
        {
