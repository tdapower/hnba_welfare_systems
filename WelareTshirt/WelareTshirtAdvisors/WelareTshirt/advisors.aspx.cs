    ...
    public partial class advisors : System.Web.UI.Page
    {
        ...
        private void loadAdvisors(string branchCode, string companyCode)
        {
            ...
            if (dr.HasRows)
            {
                ...
                
                {
                    ...
                    string text = dr[1].ToString() + "(" + dr[0].ToString() + ")";
        ...
        private void saveMainDetails()
        {
            ...
            try
            {
                ...
                spProcess.Parameters.Add("V_AGENT_CODE", OracleType.VarChar).Value = ddlAdvisorCode.SelectedValue.ToString();
                ...
                spProcess.Parameters.Add("V_SYSTEM_USER_CODE", OracleType.VarChar).Value = Session["USER_ID"].ToString();
