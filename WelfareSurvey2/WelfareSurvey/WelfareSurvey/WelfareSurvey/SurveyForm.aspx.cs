    ...
    public partial class SurveyForm : System.Web.UI.Page
    {
        ...
        private void saveMainDetails()
        {
            ...
            try
            {
                ...
                spProcess = new OracleCommand("INSERT_WS_SURVEY_2015_MAIN");
        ...
        private bool CheckUserIdAlreadySaved(string company, string EPF)
        {
            ...
            cmd.Connection = con;
            String selectQuery = "";
            selectQuery = "SELECT COMPANY,EPF_NO   FROM WS_SURVEY_2015_MAIN WHERE COMPANY  ='" + company + "'  and EPF_NO=" + EPF;
        ...
        private void deletePreviousUserRecord(string company, string EPF)
        {
            try
            {
                ...
                strQuery = "DELETE FROM WS_SURVEY_2015_MAIN WHERE  COMPANY  ='" + company + "'  and EPF_NO=" + EPF;
